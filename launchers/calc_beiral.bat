...
python -m streamlit run ..\src\beiral\app.py --browser.gatherUsageStats false --server.fileWatcherType none --server.showEmailPrompt false --server.address localhost --server.port 8507 --logger.level error
